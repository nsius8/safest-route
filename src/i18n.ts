...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    alertIn: 'Alert in',
    locations: 'locations',
    alertTypesCount: '{{count}} alert types',
    alertTypeMissiles: 'Missiles',
    alertTypeHostileAircraft: 'Hostile aircraft',
    alertTypeGeneral: 'General',
    alertTypeNewsFlash: 'News flash',
  ...
  he: {
    ...
    alertIn: 'התראה ב',
    locations: 'אזורים',
    alertTypesCount: '{{count}} סוגי התראות',
    alertTypeMissiles: 'טילים',
    alertTypeHostileAircraft: 'מטוסי אויב',
    alertTypeGeneral: 'כללי',
    alertTypeNewsFlash: 'ידיעה',
